...
// Espace au-dessus de la carte (bouton ✕ + marge)
const TOP_GUTTER = 58;
  ...
  return (
    <>
      ...
      <View style={styles.screen}>
        ...
        {/*
          ── Carte oracle ──
          cardBorder  : porte la bordure dorée (pas d'overflow, sinon la bordure
                        est dessinée à l'intérieur et crée un gap avec l'image)
          cardInner   : porte overflow:'hidden' pour arrondir l'image (sans bordure)
        */}
        <Animated.View
          style={[
            styles.cardBorder,
        ...
        {/* ── Bouton fermer – dans le gutter au-dessus de la carte ── */}
        <Pressable
